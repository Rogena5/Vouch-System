    ...
    return (
        <div className='container mx-auto px-20'>
            <form onSubmit={handleSubmit}>
                ...
                <div className='first-form grid md:grid-cols-3 grid-cols-1 gap-4 mb-7'>
                    <div>
                        <input
                            type="text"
                            name="nameOnBoard"
                            placeholder='Your Name'
                            className="text-black border-2 rounded-lg border-inherit w-full p-2 focus:border-violet-500 outline-none"
                    ...
                    <div className='flex flex-col gap-y-2'>
                        <select
                            ...
                            className="text-black border-2 rounded-lg border-inherit w-full p-2 focus:border-violet-500 outline-none"
                        >
                            <option value="hospitality" className='text-sm'>hospitality</option>
                        ...
                        <select
                            ...
                            className="text-black border-2 rounded-lg border-inherit w-full p-2 focus:border-violet-500 outline-none"
                        >
                            <option value="New Brand or Established Activity" className='text-sm'>New Brand or Established Activity</option>
                ...
                <div className='mb-7'>
                    <p className='text-md text-gray-400 mb-4'>Vouch Acount Lead</p>
                    <div className='flex flex-col gap-y-2'>
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            className="text-black border-2 rounded-lg border-inherit  p-2 w-4/12 focus:border-violet-500 outline-none"
                        >
                            <option value="Alex Sewel" className='text-sm'>Alex Sewel</option>
                ...
                <div className='third-form grid md:grid-cols-3 grid-cols-1 gap-4 mb-7'>

                    <select
                        name="additionalTeam"
                        value={formData.additionalTeam}
                        onChange={handleChange}
                        className="text-black border-2 rounded-lg border-inherit  p-2 w-full focus:border-violet-500 outline-none"
                    >
                        <option value="Jennifer Parkerr" className='text-sm'>Jennifer Parkerr</option>
                    ...
                    <select
                        ...
                        className="text-black border-2 rounded-lg border-inherit w-full  p-2 focus:border-violet-500 outline-none"
                    >
                        <option value="Chloe Hoffmann" className='text-sm'>Chloe Hoffmann</option>
                    ...
                    <select
                        ...
                        className="text-black border-2 rounded-lg border-inherit w-full  p-2 focus:border-violet-500 outline-none"
                    >
                        <option value="Steve Robinson" className='text-sm'>Steve Robinson</option>
                ...
                <div className="mb-4">
                    {/* header */}
                    <div className='header-clientForm mb-7'>
                        <h3 className='text-2xl md:text-3xl text-black'>Core services</h3>
                ...
                {/* ___________ */}
                <div className='text-black border-2 rounded-lg border-inherit w-full p-2 focus:border-violet-500 outline-none'>
